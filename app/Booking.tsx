...
router.push(`/booking-aftar/${data._id}`);
  ...
  return (
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <table className="font-medium">
              ...
              <textarea
                ...
                value={formData.note}
                onChange={handleChange}
               className="input resize-none border-green-400 border-2 rounded-3xl w-85 md:w-96"
    ...
    <div className='flex justify-around'>
       ...
       <div className=' h-52 bg-white p-6 rounded-xl shadow-md w-80 md:w-96  ' style={{margin:"90px auto"}}>
